                    ...
                    <ul className="tri-info">
                      <span className="s-cir">
                        <div className="img-icon">
                          <img src={FutureGlobe} alt="" />
                        </div>
                      </span>
                      <li className="text">
                        <h5>NFT Lords & Lands Presale</h5>
                        <p>Unveiling the fresh look of 500 Lords & 500 Lands</p>
                      </li>
                    </ul>
                    <span id="player">
                      <div id="outer">
            ...
            <div className="col-lg-6 col-md-6 col-sm-6">
              <div className="main-info-2">
                <ul className="tri-info">
                  ...
                  <li className="text">
                    <h5>NFT Full-Stack Sale</h5>
                    <p>
                      Full Stack sale of +2000 Lord, +2500 Lands, Mobility,
              ...
              <div className="main-info-3 ">
                <ul className="tri-info">
                  <span className="s-cir">
                    <div className="img-icon">
                      <img src={rentdistribution} alt="" />
                    </div>
                  </span>
                  <li className="text">
                    <h5>Rent distribution</h5>
                    <p>
                      First monthly rental distribution amongst all Land Lords
                    </p>
                  </li>
                </ul>
                <span id="player">
              ...
              <div className="main-info-4">
                <ul className="tri-info">
                  ...
                  <li className="text">
                    <h5>Import</h5>
                    <p>
                      Import of all NFTs into the ProperTland Metaverse, where
                      Lords & their Lands will rule
                    </p>
                  </li>
                </ul>
                <span id="player">
              ...
              <div className="main-info-5">
                <ul className="tri-info">
                  ...
                  <li className="text">
                    ...
                    <p>Special powers to Lords & Features to Lands</p>
                  </li>
                </ul>
                <span id="player">
                  <div id="outer">
